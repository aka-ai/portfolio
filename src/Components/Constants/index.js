...
const Constants = {
  ...
  cottonCandyBackground :[
    ...
    { offset: 0, speed: 0.2, style: { opacity: 0.4 }, imgStyle: { width: '10%', marginLeft: '2%' } },
    ...
    { offset: 1, speed: 0.2, style: { opacity: 0.4 }, imgStyle: { width: '10%', marginLeft: '2%' } },
    ...
    { offset: 2, speed: 0.2, style: { opacity: 0.4 }, imgStyle: { width: '10%', marginLeft: '2%' } },
    ...
    { offset: 3, speed: 0.2, style: { opacity: 0.4 }, imgStyle: { width: '10%', marginLeft: '2%' } },
    ...
    { offset: 4, speed: 0.2, style: { opacity: 0.4 }, imgStyle: { width: '10%', marginLeft: '2%' } },
